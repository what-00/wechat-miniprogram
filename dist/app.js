...
__webpack_require__.d(__webpack_exports__, "navigateTo", function() { return /* reexport */ navigateTo; });
__webpack_require__.d(__webpack_exports__, "navigateBack", function() { return /* reexport */ navigateBack; });
__webpack_require__.d(__webpack_exports__, "redirectTo", function() { return /* reexport */ redirectTo; });
__webpack_require__.d(__webpack_exports__, "reLaunch", function() { return /* reexport */ reLaunch; });
__webpack_require__.d(__webpack_exports__, "switchTab", function() { return /* reexport */ switchTab; });
...
var navigateTo=Object(esm["m" /* promisify */])(wx.navigateTo);var navigateBack=Object(esm["m" /* promisify */])(wx.navigateBack);var redirectTo=Object(esm["m" /* promisify */])(wx.redirectTo);var reLaunch=Object(esm["m" /* promisify */])(wx.reLaunch);var switchTab=Object(esm["m" /* promisify */])(wx.switchTab);
...
module.exports = require('/workers/lodash.min.js');
...
/* harmony import */ var _Library_WebServer_React_wechat_miniprogram_node_modules_remax_plugin_error_screen_lib_ErrorScreen_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var _Library_WebServer_React_wechat_miniprogram_node_modules_remax_plugin_error_screen_lib_ErrorScreen_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_Library_WebServer_React_wechat_miniprogram_node_modules_remax_plugin_error_screen_lib_ErrorScreen_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _Library_WebServer_React_wechat_miniprogram_node_modules_remax_plugin_error_screen_lib_ErrorBoundary_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
/* harmony import */ var _Library_WebServer_React_wechat_miniprogram_node_modules_remax_plugin_error_screen_lib_ErrorBoundary_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_Library_WebServer_React_wechat_miniprogram_node_modules_remax_plugin_error_screen_lib_ErrorBoundary_js__WEBPACK_IMPORTED_MODULE_3__);
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly){symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});}keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){_defineProperty(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}/* harmony default export */ __webpack_exports__["default"] = ({onPageComponent:function onPageComponent(_ref){var component=_ref.component;function ErrorBoundaryWrap(props,ref){return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Library_WebServer_React_wechat_miniprogram_node_modules_remax_plugin_error_screen_lib_ErrorBoundary_js__WEBPACK_IMPORTED_MODULE_3___default.a,{errorScreen:_Library_WebServer_React_wechat_miniprogram_node_modules_remax_plugin_error_screen_lib_ErrorScreen_js__WEBPACK_IMPORTED_MODULE_2___default.a},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(component,_objectSpread(_objectSpread({},props),{},{ref:ref})));}ErrorBoundaryWrap.displayName='ErrorBoundary';return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.forwardRef(ErrorBoundaryWrap);}});
...
// EXTERNAL MODULE: external "require('/workers/lodash.min.js')"
var lodash_min_js_ = __webpack_require__(13);
var lodash_min_js_default = /*#__PURE__*/__webpack_require__.n(lodash_min_js_);
...
var app_App=function App(props){console.log('app',lodash_min_js_default.a.uniqueId('app'));Object(react["useEffect"])(function(){// const oWorker = wx.createWorker('workers/fsdpf.worker.js');
// oWorker.postMessage('remaxjs')
},[]);return props.children;};/* harmony default export */ var src_app = (app_App);
// CONCATENATED MODULE: ./src/app.entry.js
__webpack_require__(8);App(Object(esm["c" /* createAppConfig */])(src_app));
